...
if (QT4_DIR) {
	...
	await runSuite(QT4_DIR, "3.1", path.join(SRC_DIR, "qt4-snaps"), XQ31_COMPAT, testSetFiles, catalogEnvMap);
	await runSuite(QT4_DIR, "4.0", path.join(SRC_DIR, "qt4-snaps-xq4"), XQ40_COMPAT, testSetFiles, catalogEnvMap);
}
